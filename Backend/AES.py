...
# password = aes_encrypt(key, b'facebook', user='0001')
# passwords_cipher.append(password)
# password = aes_encrypt(key, b'twitter', user='0001')
# passwords_cipher.append(password)
# password = aes_encrypt(key, b'tiktok', user='0001')
# passwords_cipher.append(password)
# 
# print(passwords_cipher)
# 
# aes_decrypt(passwords_cipher[0])
# aes_decrypt(passwords_cipher[1])
# aes_decrypt(passwords_cipher[2])